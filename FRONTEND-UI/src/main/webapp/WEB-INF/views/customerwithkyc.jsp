...
<head>
    ...
    <title>Application View - ${customer.firstName}</title>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2><i class="fas fa-file-alt me-2"></i>Customer Application - ${customer.firstName} ${customer.lastName} </h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item active">Customer ID - #${customer.customerId}</li>
                                <li class="breadcrumb-item active">Document ID - #${document.id}</li>
                            </ol>
                        </nav>
                    </div>
                    <div>
